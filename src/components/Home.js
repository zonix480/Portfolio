  ...
  return (
    <Container fluid className='lexend back'>
        ...
        <Row className='mt-sm-0 pt-sm-0' style={{height:'100vh'}}>
            ...
            <Col xs={{order:2,span:12}} md={{span:6}} className='ms-md-5 d-flex flex-column justify-content-md-center order-sm-2 order-md-2 mt-sm-5 pt-sm-0' >
            <Zoom>
...
Solida experiencia en la creación de aplicaciones mobiles y web dínamicas y escalables.
            ...
            <Col   className='d-flex flex-column mt-5 justify-content-center align-items-center order-sm-1 order-xs-1'>
            <Bounce cascade>
